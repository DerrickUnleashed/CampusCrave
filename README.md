<div align="center" id="#readme-top" style="background-color: orange; padding: 20px; border-radius: 10px; display: inline-block;">
  <img src="src/assets/logo.png" alt="CampusCrave Logo" width="400"/>
</div>
